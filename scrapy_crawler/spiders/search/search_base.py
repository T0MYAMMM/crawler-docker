...
class SearchBaseSpider(BaseSpider):
    """
    ...
    def __init__(self, phrases: str = '', page_request: int = 1, debug: str = 'false', 
    ...
    def _log_initialization(self):
        ...
        if self.debug_mode:
            ...
            self.logger.debug(f"Parameters: phrases='{self.phrases}', page_request={self.page_request}")
